## Приложение, которое позволяет отслеживать почтовые отправления.
...
Сервис реализован при помощи Spring.

Может использоваться любая СУБД для хранения
данных.

Работа с данными происходит посредством
ORM.

Приложение собирается при помощи Maven.

К приложению прилагаться описание его API —
